        ...
        if (settings.viewport_resize) {
          $viewport.resizable({
            resize: function(event, ui) {
              ...
              $viewport.observator.notify('canvas_width', ui.size.width);
              $viewport.observator.notify('canvas_height', ui.size.height);
            }
          });
        }
        ...
        $.extend($viewport, {
          ...
          observator: {
            ...
            notify_all: function() {
              ...
              this.notify('canvas_width', $viewport.width());
              this.notify('canvas_height', $viewport.height());
            },
