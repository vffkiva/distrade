...
[
    ...
    { name: 'tools',       items : [ 'Maximize', 'ShowBlocks', 'Banner'] }
];
...
CKEDITOR.config.extraPlugins = 'banner';   
...
[
{name:'Distrade: normal text',element:'span',styles:{'font-family' : '\'Open Sans\',sans-serif', 'font-size' : '13px', 'color' : '#666666'}},
{name:'Distrade: list-style', element: 'ul', attributes: {class: 'distrade-list'}},
...
{name:'Banner Element', element: 'div', attributes: {class: 'banner-element'}}
]);
